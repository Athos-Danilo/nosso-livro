...
/**
 * Busca os dados de contato de um usuário no Serviço de Autenticação e Usuário.
 *
 * Realiza uma chamada HTTP GET e retorna nome, e-mail e whatsapp do usuário
 * para uso nos templates de notificação. Lança erros semânticos para falhas.
 *
 * @param idUsuario - UUID do usuário destinatário da notificação
 * @returns Dados de contato do usuário (nome, e-mail, whatsapp, ativo)
 ...
 * @throws {ErroServicoIndisponivel} Se o serviço estiver fora do ar (após retries)
 */
